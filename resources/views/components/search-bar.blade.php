...
<form action="{{ route('link.index')}}" method="get" class="flex items-center space-x-2">
    <input type="text" name="search" id="search" value="{{ request('search')}}" class="border border-gray-300 dark:border-gray-600 rounded-md p-2 focus:ring focus:ring-blue-300">
